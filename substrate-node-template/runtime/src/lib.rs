...
parameter_types! {
	...
	pub const DefaultDepositLimit: Balance = deposit(128, 128);
...
impl pallet_contracts::Config for Runtime {
	...
	type MaxCodeLen = ConstU32<256000>;
	type MaxStorageKeyLen = ConstU32<256>;

	type DefaultDepositLimit = DefaultDepositLimit;
	type UnsafeUnstableInterface = ConstBool<false>;
	type MaxDebugBufferLen = ConstU32<128000>;
	type Migrations = ();
}
